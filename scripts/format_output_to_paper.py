...
feature_importance_light = pd.read_csv(
    folder_path + "feature_importance_light.csv", index_col=0
)
...
beta_hat = {
    model_name: pd.read_csv(f"{folder_path}/beta_hat/{model_name}.csv", index_col=0)
    for model_name in ["true", "local_glm_boost", "local_glm_boost_light"]
}
